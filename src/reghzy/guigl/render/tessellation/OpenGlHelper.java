...
public class OpenGlHelper {
    ...
    public static boolean blendFuncSeparate;
    public static boolean shadersSupported;
    private static String reason0 = "";
    ...
    public static void initializeTextures() {
        GLCapabilities capabilities = GuiGLEngine.getInstance().getRenderEngine().getCapabilities();
        field_153215_z = capabilities.GL_ARB_multitexture && !capabilities.OpenGL13;
        if (field_153215_z) {
            reason0 = reason0 + "Using multitexturing ARB.\n";
        }
        else {
            reason0 = reason0 + "Using GL 1.3 multitexturing.\n";
        }

        defaultTexUnit = 33984;
        lightmapTexUnit = 33985;
        blendFuncSeparate = capabilities.GL_EXT_blend_func_separate && !capabilities.OpenGL14;
        ...
        if (framebufferSupported) {
            reason0 = reason0 + "Using framebuffer objects because ";
            if (capabilities.OpenGL30) {
                reason0 = reason0 + "OpenGL 3.0 is supported and separate blending is supported.\n";
                field_153212_w = 0;
                ...
                reason0 = reason0 + "ARB_framebuffer_object is supported and separate blending is supported.\n";
                field_153212_w = 1;
                field_153198_e = 36160;
                field_153199_f = 36161;
                field_153200_g = 36064;
                ...
                reason0 = reason0 + "EXT_framebuffer_object is supported.\n";
                field_153212_w = 2;
                field_153198_e = 36160;
                field_153199_f = 36161;
                field_153200_g = 36064;
            ...
            reason0 = reason0 + "Not using framebuffer objects because ";
            reason0 = reason0 + "OpenGL 1.4 is " + (capabilities.OpenGL14 ? "" : "not ") + "supported, ";
            reason0 = reason0 + "EXT_blend_func_separate is " + (capabilities.GL_EXT_blend_func_separate ? "" : "not ") + "supported, ";
            reason0 = reason0 + "OpenGL 3.0 is " + (capabilities.OpenGL30 ? "" : "not ") + "supported, ";
            reason0 = reason0 + "ARB_framebuffer_object is " + (capabilities.GL_ARB_framebuffer_object ? "" : "not ") + "supported, and ";
            reason0 = reason0 + "EXT_framebuffer_object is " + (capabilities.GL_EXT_framebuffer_object ? "" : "not ") + "supported.\n";
        }
        ...
        reason0 = reason0 + "Anisotropic filtering is " + (anisotropicFilteringSupported ? "" : "not ") + "supported";

        if (anisotropicFilteringSupported) {
            reason0 = reason0 + " and maximum anisotropy is " + anisotropicFilteringMax + ".\n";
        }
        else {
            reason0 = reason0 + ".\n";
        }
        ...
        reason0 = reason0 + "Shaders are " + (field_153213_x ? "" : "not ") + "available because ";

        if (field_153213_x) {
            if (capabilities.OpenGL21) {
                reason0 = reason0 + "OpenGL 2.1 is supported.\n";
                field_153214_y = false;
            }
            else {
                reason0 = reason0 + "ARB_shader_objects, ARB_vertex_shader, and ARB_fragment_shader are supported.\n";
                field_153214_y = true;
            }
            ...
            reason0 = reason0 + "OpenGL 2.1 is " + (capabilities.OpenGL21 ? "" : "not ") + "supported, ";
            reason0 = reason0 + "ARB_shader_objects is " + (capabilities.GL_ARB_shader_objects ? "" : "not ") + "supported, ";
            reason0 = reason0 + "ARB_vertex_shader is " + (capabilities.GL_ARB_vertex_shader ? "" : "not ") + "supported, and ";
            reason0 = reason0 + "ARB_fragment_shader is " + (capabilities.GL_ARB_fragment_shader ? "" : "not ") + "supported.\n";
        }
    ...
    public static void func_153169_a(int p_153169_0_, CharSequence p_153169_1_) {
        if (field_153214_y) {
